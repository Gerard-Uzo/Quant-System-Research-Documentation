...
![Framework Evolution Diagram](../diagrams/evolution_diagram.png)

- A visual showing the transition from the tangled "Alchemist CE Monolith" to the clean, decoupled "KANG Modular Pipeline" (Config -> Engine -> Artifacts).
